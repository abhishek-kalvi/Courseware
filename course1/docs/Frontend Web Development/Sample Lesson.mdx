...
``` js
  console.log("These are multiple lines of code")
```
...
[Version 1:](/course1/docs/Frontend%20Web%20Development/Sample%20Lesson#what-are-html-text-fundamentals)
...
![GIF for links](https://media.giphy.com/media/B7o99rIuystY4/giphy.gif)
